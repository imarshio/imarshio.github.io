...
参考官网：[linux installation yum repo](https://dev.mysql.com/doc/refman/8.4/en/linux-installation-yum-repo.html)

1、添加 YUM Repository

在 [MySQL Yum Repository](https://dev.mysql.com/downloads/repo/yum/) 页面选择并下载合适的版本包，包文件格式为：`mysql84-community-release-{platform}-{version-number}.noarch.rpm`
