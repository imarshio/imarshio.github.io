...
- 文件命名：除 `README.md` 文件外，其他文件一律采用 `aword-bword-cword.md` 的命名规则，文件夹同理。

## TODO

- [x] 导航，现在只会默认展示首页，但是首页目前只代表了一个md文件，多md文件无法同时展现出来
- [x] 主题，目前使用的是官方默认主题，大家都知道这个主题非常的简洁易用，但是我个人对博客的感觉还是会带一些其他的期待，要在简洁的同时兼顾美感，经过一番筛选，最终确定了未来将要扩展的主题为：[hope](https://theme-hope.vuejs.press/)
- [x] 迁移，之前写的一些blogs都会相继迁移到新的blog中，敬请期待啊
- [x] 部署，虽然部署的文档流程已经通读完成了，但是还没有进行详细的操作，其中涉及到了[Github Actions](https://github.com/features/actions)
- [ ] 其他，完成整理沉淀之后，会对后续的方向、短期规划做一下扩展，比如吃透一个中间件，读一些好书
- [ ] 学习
  - [ ] vue 刚入门，写过一些简单的页面
  - [ ] react
  - [ ] javascript
  - [x] python，flask + ai 实战项目
  - [ ] swift
  - [ ] 算法
- [ ] 升级主题版本
